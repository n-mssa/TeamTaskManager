...
- تحفظ الملفات المرفوعة في Supabase Storage داخل bucket باسم `task-attachments`.
- يحتاج الـ backend إلى `SUPABASE_URL` و`SUPABASE_SERVICE_ROLE_KEY` و`SUPABASE_STORAGE_BUCKET`.
