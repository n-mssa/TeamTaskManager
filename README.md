...
راجع [DEPLOYMENT.md](DEPLOYMENT.md) لإعداد قاعدة بيانات Supabase ونشر الواجهة
والـ backend من GitHub باستخدام Render.

## مرفقات المهام

- يمكن إضافة حتى 3 مرفقات عند إنشاء مهمة جديدة.
- الحد الأقصى لكل مرفق هو 10 ميجابايت.
- تحفظ الملفات المرفوعة داخل `backend/uploads/` أثناء التشغيل، وهذا المسار مستثنى من git.
- على Render، استخدم تخزينًا دائمًا أو تخزين ملفات خارجيًا إذا كانت المرفقات يجب أن تبقى بعد إعادة النشر أو إعادة التشغيل.
